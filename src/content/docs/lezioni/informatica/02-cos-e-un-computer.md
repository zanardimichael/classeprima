...
Per capire la differenza, immagina un pianoforte: il pianoforte fisico, con i suoi tasti e le sue corde, rappresenta l'hardware; la musica che viene suonata, invisibile ma fondamentale, rappresenta il software.

## 1. L'Hardware (Il corpo)
Il termine **hardware** deriva dall'unione delle parole inglesi *hard* (duro) e *ware* (manufatto/oggetto). Indica tutta la parte fisica, meccanica ed elettronica del computer, insomma tutto ciò che si può letteralmente toccare o prendere a calci!

L'hardware è organizzato in una **Unità Centrale** e in una serie di **Periferiche**. Al centro di tutto c'è la **Scheda Madre**, una piastra elettronica che fa da ponte di collegamento per tutti gli altri componenti. I tre elementi vitali ospitati o collegati alla scheda madre sono:
...
## 2. Le Periferiche (I sensi del computer)
